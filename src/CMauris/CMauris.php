...
class CMauris implements ISingleton {
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= MAURIS_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = MAURIS_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $ma = &$this;
    // First the default Mauris themes/functions.php
    include(MAURIS_INSTALL_PATH . '/themes/functions.php');
