<?php
/**
 * Holding a instance of CMauris to enable use of $this in subclasses and provide some helpers.
 *
 * @package MaurisCore
 */
class CObject {
	...
	/**
	 * Wrapper for same method in CMauris. See there for documentation.
	 */
