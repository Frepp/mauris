<?php
/**
 * A model for managing Mauris modules.
 * 
 * @package MaurisCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $maurisCoreModules = array('CMauris', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $maurisCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isMaurisCore']   = in_array($rc->name, $this->maurisCoreModules);
      $details['isMaurisCMF']    = in_array($rc->name, $this->maurisCMFModules);
