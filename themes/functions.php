...
function theme_url($url) {
  return create_url(CMauris::Instance()->themeUrl . "/{$url}");
}
...
/**
 ...
 function theme_parent_url($url) {
   return create_url(CMauris::Instance()->themeParentUrl . "/{$url}");
  }
...
function region_has_content($region='default' /*...*/) {
  return CMauris::Instance()->views->RegionHasView(func_get_args());
}
...
function render_views($region='default') {
  return CMauris::Instance()->views->Render($region);
}
